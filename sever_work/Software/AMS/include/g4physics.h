//  $Id: g4physics.h,v 1.19 2018/11/30 07:23:27 choutko Exp $
...
class AMSG4Physics: public AMSNode, public G4VModularPhysicsList
{
public:
  AMSG4Physics();
...
public:  
  ...
  static bool RemoveProcess(G4ParticleDefinition *p, const string & name);
  static void SaveXS(int ipart);   
  static vector<int> XSId;
protected:
  AMSIDi* _pg3tog4;
  AMSIDs* _pg4tog3;
  integer _Ng3tog4; 
