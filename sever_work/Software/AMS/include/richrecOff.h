//  $Id: richrecOff.h,v 1.4 2025/05/24 17:20:25 choutko Exp $

#ifndef __RICHRECOFF__
#define __RICHRECOFF__
#define f2cFortran
#include "cfortran.h"
...
#pragma omp threadprivate(_event)
  public:
    integer _status;
    TrTrack* _ptrack;
...
#define _TILES_ 108 
  ...
  public:
    void CalcBetaError();
    void ReconRingNpexp(geant window_size=3.,int cleanup=0, int iring=0);
...
static RichRing* build(AMSEventR *event,AMSPoint p,AMSDir d);
    ...
    static RichRing* build(AMSEventR *event,RichRingR *ring,bool force=false);
