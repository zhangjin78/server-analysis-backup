//  $Id: TofSimUtil.h,v 1.12 2024/02/01 16:49:24 qyan Exp $
...
public:
 ...
 TOFgvolume (const char matter[],const char shape[],int _npar, geant par[],G4LogicalVolume *pg4l);
 virtual void _init(){};
 G4LogicalVolume *GetSameG4Vol(const char matter[],const char shape[],int npar, geant par[]);
 inline int    getnpar()   {return _npar;}
 inline geant* getpar(){return _par;}
 inline char*  getmatter(){return _matter;}
 inline char* getshape(){return _shape;}
 G4LogicalVolume* getvol(){return _pg4l;}
 TOFgvolume *findgvolume(G4LogicalVolume *g4l);
...
class TofSimUtil
{
  private:
   ...
   G4Material* TOFAl_M2;//Al
//--New2
   G4Material* TOFAl_MU;//Al
   G4Material* TOFAl_MM;//Al
   G4Material* TOFAl_ML;//Al
   G4Material* TOFAl_MExt;
//--
   G4Material* TOFAlHoney_M;
   G4Material* TOFAlHoneyUL_M[2];
   G4Material* TOFAlHoneyUL_M2[2];
...
//--New
  static G4double DHoneyUL[6][3];
  static G4double PHoneyUL[6][3];
...
//--New2
  static G4double DHoneyUL2[9][3];
  static G4double PHoneyUL2[9][3];
  static G4double DCarbon2UL2;
  static G4double PCarbon2UL2[2][3];
  static G4double PCarbon3UL2[2][3];
  static G4double DHoneyUL3[9][3];
  static G4double PHoneyUL3[9][3];
