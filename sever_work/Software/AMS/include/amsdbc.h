//  $Id: amsdbc.h,v 1.54 2025/01/31 11:34:23 nbelyaev Exp $
...
//
  ...
  static const uinteger ECHCISBAD;
  static const uinteger ECLCISBAD;
  static const uinteger ECDCISBAD;
  ...
  static unsigned int convert4(char *c,unsigned int nw);
  static unsigned int convert2(char *c,unsigned int nw,bool force=false);
  static unsigned int convert8(char *c,unsigned int nw);
};
