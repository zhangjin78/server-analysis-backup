//  $Id: TrCalDB.C,v 1.23 2025/04/11 16:09:51 nbelyaev Exp $
  ...
  if(Head==0){
    ...
    for(int oct=0;oct<8;oct++){
      ...
      for(int tdr=0;tdr<24;tdr++){
	      int hwid=crate*100+tdr; // For now, keeping the same hwid calculation for the L0 <<##>>
