...
// ----------------------------------------------------------
// History
//    Created:  04-Nov-2015 Q.Yan qyan@cern.ch
//    Glauber-Gribov XS Plus++ (with ISS measured XS shape tuning)
// ----------------------------------------------------------

//#if G4VERSION_NUMBER  > 945 
#ifndef G4GGNuclNuclCrossSectionQ_h
#define G4GGNuclNuclCrossSectionQ_h
...
class G4GGNuclNuclCrossSectionQ : public G4VCrossSectionDataSet
{
public:

  G4GGNuclNuclCrossSectionQ ();
  virtual ~G4GGNuclNuclCrossSectionQ ();
    
  static const char* Default_Name() {return "Glauber-GribovQ nucleus nucleus";}
  ...
  G4double GetInelasticXsCC(const G4DynamicParticle *);
  ...
  {G4cout << "G4NuclNuclCrossSection: uses Glauber-GribovQ formula"<<G4endl;}
...
inline G4double
G4GGNuclNuclCrossSectionQ::GetElasticGlauberGribov(const G4DynamicParticle* dp,
                                                  G4int Z, G4int A)
{
...
inline G4double
G4GGNuclNuclCrossSectionQ::GetInelasticGlauberGribov(const G4DynamicParticle* dp,
                                                    G4int Z, G4int A)
{
  GetZandACrossSection(dp, Z, A);
