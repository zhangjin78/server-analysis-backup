# $Id: NetMonitor.pm,v 1.80 2020/07/30 16:52:57 bshan Exp $
# May 2006  V. Choutko 
package NetMonitor;
use Net::Ping;
use strict;
...
$ENV{AMSDataDir}="/cvmfs/ams.cern.ch/Offline/AMSDataDir";
$ENV{AMISERVER} = "http://pcamsj3.cern.ch:8081";
...
my %fields=(
  sendmail=>[],
  hosts=>[],
  excluded=>['pcamsj2','pcamsr0','pcamsdt1','pcamsj0','scamsnd0','scamsnd1','pcamsj1','pcamsf6','scamsnd2','scamsnd3','pcamsj0','amsvobox03','amsvobox04','amsvobox12','pcposc1','pcamsdt1','pcamsn0','amsvobox11','amsvobox01','amsvobox02','scamsnd4','amsvobox05','amsvobox06','amsvobox07','amsvobox10','amsvobox13','amsvobox14','pcamsf3','pcamsf9','pcamsp1','pcamsf7','pcamsap','pcamsd1','pcamsvc','pcamsdt0','pcamst0','pcamsd3','scamsfs1','lxplus','scamsnd5'], 
#  dbhosts=>['pcamss0','scamsfs0'],
  dbhosts=>['ams-soc-server','scamsfs0'],
  sbhost=>'ams-soc-server',
...
#[ae 29.09.2019]   dbhoststargets=>['amsprodserverv5.exe','frame_decode'],
   dbhoststargets=>['frame_decode'],
   filesystems=>['f2users','fc03dat0'],
...
my $dmfeilds={
        warn_level=>30000,
        src_dirs=>['/afs/cern.ch/ams/local/logs','/afs/cern.ch/ams/local/bsubs','/afs/cern.ch/ams/Offline/AMSDataDirRW/prod.log/scripts','/afs/cern.ch/ams/local/prod.log/Producer','/afs/cern.ch/ams/local/logs/production_logs','/afs/cern.ch/ams/local/prod.log/MCProducer'],
        dst_dir=>'/fcpoc00/scratch/MC/afsbackup',
        dst_dir2=>'/fcpoc00/scratch/MC/afsbackup',
...
push @{$self->{sendmail}},{first=>1,repet=>21600,address=>'Alexandre.Eline@cern.ch 41754114733@mail2sms.cern.ch',sent=>0,timesent=>0};
push @{$self->{sendmail}},{first=>1,repet=>21600,address=>'baosong.shan@cern.ch 41754119642@mail2sms.cern.ch',sent=>0,timesent=>0};
push @{$self->{sendmail}},{first=>1,repet=>21600,address=>'aegorov@cern.ch 41754116488@mail2sms.cern.ch',sent=>0,timesent=>0};
   #  excluded hosts
...
#            print $host->[0];
        ...
        push @{$self->{dbhosts}}, "ams-soc-server.cern.ch";
    }
}
