//  $Id: AMSDisplay.h,v 1.39 2025/05/16 20:07:35 choutko Exp $
#ifndef AMSDisplay_H
#define AMSDisplay_H
...
private:
  ...
  bool m_drawrichringfromplex;
	  bool m_drawrichringx;
	  bool m_drawtrtrackinter;
	  bool m_rebuildacc;
	  bool m_orderedread;
	  bool m_listread;
	...
	public:
	  ...
	  bool & DrawRichRingX(){return m_drawrichringx;}
  bool & DrawTrTracksInter(){return m_drawtrtrackinter;}
  bool & RebuildACC(){return m_rebuildacc;}
  bool & ReadOrdered(){return m_orderedread;}
  bool & ReadFromList(){return m_listread;}
