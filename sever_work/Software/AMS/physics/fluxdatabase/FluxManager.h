//  $Id: FluxManager.h,v 1.3 2019/09/26 13:19:40 qyan Exp $
//////////////////////////////////////////////////////////////////////////
///
...
*/
    static TGraphErrors *ConvertERTGraphErrors(double ZVA,TGraphErrors *gr,int opt=1,int opt2=1);
}; 
...
//========================================================
TGraphErrors * FluxManager::ConvertERTGraphErrors(double ZVA,TGraphErrors *gr,int opt,int opt2){
...
const double FluxManager::PMass=0.938; 
#endif 
