...
# setenv ROOTSYS /afs/cern.ch/ams/Offline/root/Linux/root6-14-04-icc19
 ...
 setenv ROOTSYS $Offline/root/Linux/root6-14-04-icc64.24-el9
else if ($USLC == 5) then
...
# setenv ROOTSYS $Offline/root/Linux/root-v5-34-9-icc64.23-slc9
 setenv ROOTSYS $Offline/root/Linux/root-v5-34-9-icc64.24-el9
endif
...
#  setenv INTELVER compilers_and_libraries_2019.0.117
  ...
  setenv INTELSW /cvmfs/projects.cern.ch
  setenv INTELDIR $INTELSW/intelsw/oneAPI/linux/x86_64/2024
  setenv INTELVER compiler/latest
  setenv CMPLR_ROOT $INTELDIR/$INTELVER
  setenv PKG_CONFIG_PATH $CMPLR_ROOT/lib/pkgconfig
  setenv PATH $CMPLR_ROOT/bin:${PATH}
  setenv LD_LIBRARY_PATH $CMPLR_ROOT/lib:$CMPLR_ROOT/opt/compiler/lib:${LD_LIBRARY_PATH}
  setenv CMAKE_PREFIX_PATH $CMPLR_ROOT/lib/cmake/IntelDPCPP
  setenv NLSPATH $CMPLR_ROOT/lib/intel64_lin/locale/%l_%t/%N
endif
