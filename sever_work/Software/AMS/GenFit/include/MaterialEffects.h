...
#ifdef JUQUEEN
  static MaterialEffects* instance_[65];
#else
  static MaterialEffects* instance_;
#pragma omp threadprivate (instance_)
#endif
...
public:
  ...
  void setAllEffects(bool opt =true) {energyLossBetheBloch_=noiseBetheBloch_=energyLossBrems_=noiseBrems_=noiseCoulomb_=true; noEffects_ = false;}
  ...
  */
  ...
  //! set mass and charge
  void setParticleMassCharge(double mass, double charge);
 private:
