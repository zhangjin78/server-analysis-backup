...
//
G4_DECLARE_XS_FACTORY(G4GGNuclNuclCrossSectionQ);


G4GGNuclNuclCrossSectionQ::G4GGNuclNuclCrossSectionQ() 
...
void
G4GGNuclNuclCrossSectionQ::CrossSectionDescription(std::ostream& outFile) const
{
  outFile << "G4GGNuclNuclCrossSectionQ calculates total, inelastic and\n"
...
G4bool 
G4GGNuclNuclCrossSectionQ::IsElementApplicable(const G4DynamicParticle*, 
...
G4double G4GGNuclNuclCrossSectionQ::
...
//--I only tune Inelastic(+Total) XS shape, no changing of Elastic XS
    fInelasticXsc = fInelasticXsc*GetInelasticXsCC(aParticle);
...
G4double 
G4GGNuclNuclCrossSectionQ::GetHadronNucleonXsc(const G4DynamicParticle* aParticle, 
...
G4double 
G4GGNuclNuclCrossSectionQ::GetHadronNucleonXscPDG(const G4ParticleDefinition* pParticle,
                                                 G4double sMand, 
...
G4double 
G4GGNuclNuclCrossSectionQ::GetHadronNucleonXscNS(const G4ParticleDefinition* pParticle,
                                                 G4double pTkin, 
                                                 const G4ParticleDefinition* tParticle)
{
  G4double xsection(0);
...
G4double 
G4GGNuclNuclCrossSectionQ::GetHNinelasticXscVU(const G4DynamicParticle* aParticle, 
                                              G4int At, G4int Zt)
{
...
///////////////////////////////////////////////////////////////////////////////
// AMS measured XS shape tuning(Q.Yan qyan@cern.ch)
//

G4double G4GGNuclNuclCrossSectionQ::GetInelasticXsCC(const G4DynamicParticle *aParticle){
  ...
  G4double proj_rigidity=proj_momentum/pZ;
  Xscc=0.174411/(1.+2.19342*std::pow(proj_rigidity,-1.43351))+0.825589;
...
G4double 
G4GGNuclNuclCrossSectionQ::GetNucleusRadius(const G4DynamicParticle* , 
                                           const G4Element* anElement)
{
...
G4double 
G4GGNuclNuclCrossSectionQ::GetNucleusRadius(G4double Zt, G4double At)
{
  G4double R;
...
G4double 
G4GGNuclNuclCrossSectionQ::GetNucleusRadiusGG(G4double At)
{
  G4double oneThird = 1.0/3.0;
  G4double cubicrAt = std::pow (At, oneThird); 
...
G4double 
G4GGNuclNuclCrossSectionQ::GetNucleusRadiusDE(G4double Z, G4double A)
{
...
G4double 
G4GGNuclNuclCrossSectionQ::GetNucleusRadiusRMS(G4double Z, G4double A)
{
...
G4double G4GGNuclNuclCrossSectionQ::CalculateEcmValue(const G4double mp, 
                                                     const G4double mt, 
                                                     const G4double Plab)
{
...
G4double G4GGNuclNuclCrossSectionQ::CalcMandelstamS(const G4double mp, 
                                                   const G4double mt, 
                                                   const G4double Plab)
{
  G4double Elab = std::sqrt ( mp * mp + Plab * Plab );
