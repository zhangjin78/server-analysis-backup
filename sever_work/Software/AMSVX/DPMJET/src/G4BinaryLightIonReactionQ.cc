...
G4BinaryLightIonReactionQ::G4BinaryLightIonReactionQ(G4VPreCompoundModel* ptr)
  ...
  projectile3dNucleus(0),target3dNucleus(0)
{
	...
	theModel = new G4BinaryCascadeQ(theProjectileFragmentation);
...
G4BinaryLightIonReactionQ::~G4BinaryLightIonReactionQ()
{}

void G4BinaryLightIonReactionQ::ModelDescription(std::ostream& outFile) const
{
...
G4HadFinalState *G4BinaryLightIonReactionQ::
...
//	G4double m_nucl(0);      // to check energy balance
	...
	else
	{
      ...
      G4double theStatisticalExEnergy = fEexc*GetProjectileExcitation();
...
//****************************************************************************
G4bool G4BinaryLightIonReactionQ::EnergyAndMomentumCorrector(
...
//****************************************************************************
{
	...
	{
		G4cout << "G4G4BinaryLightIonReactionQ::EnergyAndMomentumCorrector - Warning"<<G4endl;
...
G4bool G4BinaryLightIonReactionQ::SetLighterAsProjectile(G4LorentzVector & mom,const G4LorentzRotation & toBreit)
{
...
G4ReactionProductVector * G4BinaryLightIonReactionQ::FuseNucleiAndPrompound(const G4LorentzVector & mom)
{
...
G4ReactionProductVector * G4BinaryLightIonReactionQ::Interact(G4LorentzVector & mom, const G4LorentzRotation & toBreit)
{
      G4ReactionProductVector * result = 0;
...
G4double G4BinaryLightIonReactionQ::GetProjectileExcitation()
{
...
G4LorentzVector G4BinaryLightIonReactionQ::SortResult(G4ReactionProductVector * result, G4ReactionProductVector * spectators,G4ReactionProductVector * cascaders)
{
   unsigned int i(0);
...
void G4BinaryLightIonReactionQ::DeExciteSpectatorNucleus(G4ReactionProductVector * spectators, G4ReactionProductVector * cascaders,
