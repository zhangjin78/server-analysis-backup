...
*              to allow for fragmentation
      ...
      IPSQ2(J)=1.D0+RNDMDPM(v1)*(2.D0+2.D0*SEASQ)
        RR=RNDMDPM(V)
...
!$OMP THREADPRIVATE (/NUCIMP/)
      COMMON /FERMICB/ PQUAR(4,248),PAQUAR(4,248), TQUAR(4,248),TAQUAR
     +(4,248)
*KEEP,DPAR.
...
*              to allow for fragmentation
      ITSQ2(J)=1.D0+RNDMDPM(v1)*(2.D0+2.D0*SEASQ)
        RR=RNDMDPM(V)
...
*  kinematics: is the mass of the adiquark-diquark chain big enough
*              to allow for fragmentation
      IPSQ2(IPS)=1.D0+RNDMDPM(v1)*(2.D0+2.D0*SEASQ)
      RR=RNDMDPM(V)
...
C----------------------------------------------------------------------
        RR=RNDMDPM(V)
        IS=1.D0+RNDMDPM(V1)*(2.D0+2.D0*SEASQ)
	IF(RR.LT.PC)IS=4
C----------------------------------------------------------------------
...
*  kinematics: is the mass of both chains big enough
*              to allow for fragmentation
      ITSQ2(ITS)=1.D0+RNDMDPM(v1)*(2.D0+2.D0*SEASQ)
        RR=RNDMDPM(V)
...
*  kinematics: is the mass of the adiquark-diquark chain big enough
*              to allow for fragmentation
      IPSQQ1=1.D0+RNDMDPM(V1)*(2.D0+2.D0*SEASQ)
        RR=RNDMDPM(V)
...
C     IF(RND.LT.0.24) IPSQQ2=3
      IPSQQ2=1.D0+RNDMDPM(V1)*(2.D0+2.D0*SEASQ)
        RR=RNDMDPM(V)
