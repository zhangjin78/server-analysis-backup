...
!$OMP THREADPRIVATE (/OUTLEV/)
      ...
      DO 20 I=1,MPO
        ES=-2./(B33**2)*LOG(RNDMDPM(V)*RNDMDPM(U))
...
C                            REJECT EVENT
          RETURN
        ENDIF
        ES=-2./(B33**2)*LOG(ABS(RNDMDPM(V)*RNDMDPM(U))+1.E-18)
        HPS=SQRT(ES*ES+2.*ES*0.94)
        CALL DSFECF(SFE,CFE)
...
C repl:COMMON/DIFFRADPM/ISINGD,IDUBLD,SDFRAC
...
C                                 REJECT TOTAL EVENT FOR IC302=12
          ...
          XXXG1=(RNDMDPM(V))**0.50
          XXXG2=(RNDMDPM(U))**0.50
          IF (NUGLUU.EQ.1) THEN
...
C                                  FLAVORS OF QUARKS
          AI=I
          BI=I+I
          IPJQ1=1.D0+RNDMDPM(QA1)*(2.D0+SEASQ)
          IF(RNDMDPM(V3).LT.PCCC)IPJQ1=4
          IPJAQ1=-IPJQ1
          IPJQ2=1.D0+RNDMDPM(QB1)*(2.D0+SEASQ)
          IF(RNDMDPM(V4).LT.PCCC)IPJQ2=4
          IPJAQ2=-IPJQ2
...
C                                     Single chain probability  
            ...
            IF (RNDMDPM(V).LE.SICHAP)NSICHA=1
...
!$OMP THREADPRIVATE (/SHMAKL/)
      ...
      AIDANN=IDANN
      FDANN=DANN-AIDANN
      IF(RNDMDPM(V).LT.FDANN)IDANN=IDANN+1
...
C                                 REJECT THE TOTAL EVENT
            ...
            GO TO 1199
	  ENDIF
          IF (RNDMDPM(V1).LT.ALOOO1)THEN
            XGLU1=RNDMDPM(A2)*(XPTHRX-XSTHR2)+XSTHR2
          ELSE
   25       CONTINUE
C................................................................a
...
C................................................................
          ENDIF
          IF (RNDMDPM(V3).LT.ALOOO2)THEN
            XGLU2=RNDMDPM(A4)*(XPTHRX-XSTHR2)+XSTHR2
          ELSE
   26       CONTINUE
C................................................................
	    IF(SEAQX.LE.0.75D0)THEN
...
C                 Are these xglu values allowed
  ...
  109     FORMAT (' XPTFL1  XGLU1,XGLU2 ',2F10.6)
          AI=I
          BI=I+I
          IPSQ1=1.D0+RNDMDPM(QA1)*(2.D0+SEASQ)
          IF(RNDMDPM(W1).LT.PC)IPSQ1=4
          IPSAQ1=-IPSQ1
          IPSQ2=1.D0+RNDMDPM(QB1)*(2.D0+SEASQ)
          IF(RNDMDPM(W2).LT.PC)IPSQ2=4
          IPSAQ2=-IPSQ2
...
C------------------------------------------------------j.r.29.4.93
          IF(IPSQ1.LE.2)THEN
            XPSQ1=(0.2+(0.36*RNDMDPM(A1))**0.50)*XGLU1
            XPSAQ1=XGLU1-XPSQ1
...
C                                 REJECT THE TOTAL EVENT
              ...
              SOXUS1=0.
              SOXUS2=0.
	      IF(IOUXEV.GE.4) WRITE(6,*)' xptfl1 LPO,SOXUS1,SOXUS2
     *	 reject ',  LPO,SOXUS1,SOXUS2
              GO TO 1199
	    ENDIF
...
C           XPSAQ1=SAMPXB(XSTHR+BSQ,0.9D0,BSQ)
          ...
          ENDIF
          IF(IPSQ2.LE.2)THEN
            XPSQ2=(0.2+(0.36*RNDMDPM(B1))**0.50)*XGLU2
            XPSAQ2=XGLU2-XPSQ2
...
C
       ...
       NDIQZD=0
C      AME=0.9
       IF(RNDMDPM(V).GT.2.D0*AMEDD-1.D0)THEN
         IF(IDIQUU.EQ.1)THEN
...
C            GO TO 20
         ...
         ENDIF
       ENDIF
       IF(RNDMDPM(V).GT.2.D0*AMEDD-1.D0.AND.NDIQDZ.EQ.0)THEN
         IF(IDIQUU.EQ.1)THEN
