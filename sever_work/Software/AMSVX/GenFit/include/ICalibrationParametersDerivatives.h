...
class ICalibrationParametersDerivatives {
 ...
 public:
    ...
    */
    virtual TMatrixD globalDerivatives(const StateOnPlane* sop) {return TMatrixD();}
//   virtual std::pair<std::vector<int>, TMatrixD> globalDerivatives(const StateOnPlane* sop) {return alignderglobal;}
    ...
    */
   virtual std::vector<int> &globalLabels() {return gmalignders_.first;}
    ...
    */
   virtual TMatrixD localDerivatives(const StateOnPlane*) {return TMatrixD();}
   ...
   virtual void setglobalMAlignDers(const std::pair<std::vector<int>,TMatrixD> &gmalignders){
     gmalignders_.second.ResizeTo(gmalignders.second);
     gmalignders_=gmalignders;
   }
   virtual bool isValidCalib(){return false;} 
 
 protected:
   std::pair<std::vector<int>,TMatrixD> gmalignders_;
};
