//  $Id: GeoMagField.C,v 1.13 2023/12/19 19:26:06 qyan Exp $
...
int GeoMagField::InitModel(const char *mdfile, double date)
{
  ...
  TString mfile=AMSDATADIR.amsdatadir;//the directory has been changed to v6.00
  mfile+="IGRF13.COF";
  if (!mdfile) mdfile = mfile.Data();
