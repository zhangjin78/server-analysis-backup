...
MVAmanager::MVAmanager(ConfigParser*  aconf) {
  ...
  reader=0;
  factory=0;
#if ROOT_VERSION_CODE > ROOT_VERSION(6,7,2)
  dataloader=0;
#endif
  mycuts=0;
  mycutb=0;
...
void  MVAmanager::bookfactory() {
	 ...
	 TString BDT_Trees= string(fmvatree).c_str();

#if ROOT_VERSION_CODE > ROOT_VERSION(6,7,2)
#define ROOT_DATALOADER_MAYBE dataloader,
#else
#define ROOT_DATALOADER_MAYBE
#endif
   // Cut optimisation
   if (Use["Cuts"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kCuts, "Cuts",
                           "!H:!V:FitMethod=MC:EffSel:SampleSize=200000:VarProp=FSmart" );

   if (Use["CutsD"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kCuts, "CutsD",
                           "!H:!V:FitMethod=MC:EffSel:SampleSize=200000:VarProp=FSmart:VarTransform=Decorrelate" );

   if (Use["CutsPCA"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kCuts, "CutsPCA",
                           "!H:!V:FitMethod=MC:EffSel:SampleSize=200000:VarProp=FSmart:VarTransform=PCA" );

   if (Use["CutsGA"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kCuts, "CutsGA",
                           "H:!V:FitMethod=GA:CutRangeMin[0]=-10:CutRangeMax[0]=10:VarProp[1]=FMax:EffSel:Steps=30:Cycles=3:PopSize=400:SC_steps=10:SC_rate=5:SC_factor=0.95" );

   if (Use["CutsSA"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kCuts, "CutsSA",
                           "!H:!V:FitMethod=SA:EffSel:MaxCalls=150000:KernelTemp=IncAdaptive:InitialTemp=1e+6:MinTemp=1e-6:Eps=1e-10:UseDefaultScale" );


   if (Use["Likelihood"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kLikelihood, "Likelihood",
                           "H:!V:TransformOutput:PDFInterpol=Spline2:NSmoothSig[0]=20:NSmoothBkg[0]=20:NSmoothBkg[1]=10:NSmooth=1:NAvEvtPerBin=50" );

   // Decorrelated likelihood
   if (Use["LikelihoodD"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kLikelihood, "LikelihoodD",
                           "!H:!V:TransformOutput:PDFInterpol=Spline2:NSmoothSig[0]=20:NSmoothBkg[0]=20:NSmooth=5:NAvEvtPerBin=50" );

   // PCA-transformed likelihood
   if (Use["LikelihoodPCA"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kLikelihood, "LikelihoodPCA",
                           "!H:!V:!TransformOutput:PDFInterpol=Spline2:NSmoothSig[0]=20:NSmoothBkg[0]=20:NSmooth=5:NAvEvtPerBin=50:VarTransform=PCA" ); 

   // Use a kernel density estimator to approximate the PDFs
   if (Use["LikelihoodKDE"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kLikelihood, "LikelihoodKDE",
                           "!H:!V:!TransformOutput:PDFInterpol=KDE:KDEtype=Gauss:KDEiter=Adaptive:KDEFineFactor=0.3:KDEborder=None:NAvEvtPerBin=50" ); 

   // Use a variable-dependent mix of splines and kernel density estimator
   if (Use["LikelihoodMIX"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kLikelihood, "LikelihoodMIX",
   ...
   if (Use["PDERS"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kPDERS, "PDERS",
                           "!H:!V:NormTree=T:VolumeRangeMode=Adaptive:KernelEstimator=Gauss:GaussSigma=0.3:NEventsMin=400:NEventsMax=600" );

   if (Use["PDERSD"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kPDERS, "PDERSD",
                           "!H:!V:VolumeRangeMode=Adaptive:KernelEstimator=Gauss:GaussSigma=0.3:NEventsMin=400:NEventsMax=600:VarTransform=Decorrelate" );

   if (Use["PDERSPCA"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kPDERS, "PDERSPCA",
                           "!H:!V:VolumeRangeMode=Adaptive:KernelEstimator=Gauss:GaussSigma=0.3:NEventsMin=400:NEventsMax=600:VarTransform=PCA" );

   // Multi-dimensional likelihood estimator using self-adapting phase-space binning
   if (Use["PDEFoam"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kPDEFoam, "PDEFoam",
                           "!H:!V:SigBgSeparate=F:TailCut=0.001:VolFrac=0.0666:nActiveCells=500:nSampl=2000:nBin=5:Nmin=100:Kernel=None:Compress=T" );

   if (Use["PDEFoamBoost"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kPDEFoam, "PDEFoamBoost",
                           "!H:!V:Boost_Num=30:Boost_Transform=linear:SigBgSeparate=F:MaxDepth=4:UseYesNoCell=T:DTLogic=MisClassificationError:FillFoamWithOrigWeights=F:TailCut=0:nActiveCells=500:nBin=20:Nmin=400:Kernel=None:Compress=T" );

   // K-Nearest Neighbour classifier (KNN)
   if (Use["KNN"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kKNN, "KNN",
                           "H:nkNN=20:ScaleFrac=0.8:SigmaFact=1.0:Kernel=Gaus:UseKernel=F:UseWeight=T:!Trim" );

   // H-Matrix (chi2-squared) method
   if (Use["HMatrix"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kHMatrix, "HMatrix", "!H:!V:VarTransform=None" );

   // Linear discriminant (same as Fisher discriminant)
   if (Use["LD"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kLD, "LD", "H:!V:VarTransform=None:CreateMVAPdfs:PDFInterpolMVAPdf=Spline2:NbinsMVAPdf=50:NsmoothMVAPdf=10" );

   // Fisher discriminant (same as LD)
   if (Use["Fisher"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kFisher, "Fisher", "H:!V:Fisher:VarTransform=None:CreateMVAPdfs:PDFInterpolMVAPdf=Spline2:NbinsMVAPdf=50:NsmoothMVAPdf=10" );

   // Fisher with Gauss-transformed input variables
   if (Use["FisherG"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kFisher, "FisherG", "H:!V:VarTransform=Gauss" );

   // Composite classifier: ensemble (tree) of boosted Fisher classifiers
   if (Use["BoostedFisher"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kFisher, "BoostedFisher", 
                           "H:!V:Boost_Num=20:Boost_Transform=log:Boost_Type=AdaBoost:Boost_AdaBoostBeta=0.2:!Boost_DetailedMonitoring" );

   // Function discrimination analysis (FDA) -- test of various fitters - the recommended one is Minuit (or GA or SA)
   if (Use["FDA_MC"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kFDA, "FDA_MC",
                           "H:!V:Formula=(0)+(1)*x0+(2)*x1+(3)*x2+(4)*x3:ParRanges=(-1,1);(-10,10);(-10,10);(-10,10);(-10,10):FitMethod=MC:SampleSize=100000:Sigma=0.1" );

   if (Use["FDA_GA"]) // can also use Simulated Annealing (SA) algorithm (see Cuts_SA options])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kFDA, "FDA_GA",
                           "H:!V:Formula=(0)+(1)*x0+(2)*x1+(3)*x2+(4)*x3:ParRanges=(-1,1);(-10,10);(-10,10);(-10,10);(-10,10):FitMethod=GA:PopSize=300:Cycles=3:Steps=20:Trim=True:SaveBestGen=1" );

   if (Use["FDA_SA"]) // can also use Simulated Annealing (SA) algorithm (see Cuts_SA options])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kFDA, "FDA_SA",
                           "H:!V:Formula=(0)+(1)*x0+(2)*x1+(3)*x2+(4)*x3:ParRanges=(-1,1);(-10,10);(-10,10);(-10,10);(-10,10):FitMethod=SA:MaxCalls=15000:KernelTemp=IncAdaptive:InitialTemp=1e+6:MinTemp=1e-6:Eps=1e-10:UseDefaultScale" );

   if (Use["FDA_MT"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kFDA, "FDA_MT",
                           "H:!V:Formula=(0)+(1)*x0+(2)*x1+(3)*x2+(4)*x3:ParRanges=(-1,1);(-10,10);(-10,10);(-10,10);(-10,10):FitMethod=MINUIT:ErrorLevel=1:PrintLevel=-1:FitStrategy=2:UseImprove:UseMinos:SetBatch" );

   if (Use["FDA_GAMT"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kFDA, "FDA_GAMT",
                           "H:!V:Formula=(0)+(1)*x0+(2)*x1+(3)*x2+(4)*x3:ParRanges=(-1,1);(-10,10);(-10,10);(-10,10);(-10,10):FitMethod=GA:Converger=MINUIT:ErrorLevel=1:PrintLevel=-1:FitStrategy=0:!UseImprove:!UseMinos:SetBatch:Cycles=1:PopSize=5:Steps=5:Trim" );

   if (Use["FDA_MCMT"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kFDA, "FDA_MCMT",
                           "H:!V:Formula=(0)+(1)*x0+(2)*x1+(3)*x2+(4)*x3:ParRanges=(-1,1);(-10,10);(-10,10);(-10,10);(-10,10):FitMethod=MC:Converger=MINUIT:ErrorLevel=1:PrintLevel=-1:FitStrategy=0:!UseImprove:!UseMinos:SetBatch:SampleSize=20" );

   // TMVA ANN
   if (Use["MLP"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kMLP, "MLP", "H:!V:NeuronType=tanh:VarTransform=N:NCycles=600:HiddenLayers=N+5:TestRate=5:!UseRegulator" );


   if (Use["MLPBFGS"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kMLP, "MLPBFGS", "H:!V:NeuronType=tanh:VarTransform=N:NCycles=600:HiddenLayers=N+5,N:TestRate=5:TrainingMethod=GA:!UseRegulator:CreateMVAPdfs=True" );//use regulator to avoid overtraining; TestRate=Test for overtraining performed at each #th epochs

   if (Use["MLPBNN"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kMLP, "MLPBNN", "H:!V:NeuronType=sigmoid:VarTransform=N,D:NCycles=1000:HiddenLayers=N+2,N,1:TestRate=20:TrainingMethod=BFGS:Sampling=0:ResetStep=105:UseRegulator:CreateMVAPdfs=True" ); // BFGS training with bayesian regulators

   // CF(Clermont-Ferrand)ANN
   if (Use["CFMlpANN"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kCFMlpANN, "CFMlpANN", "!H:!V:NCycles=50000:HiddenLayers=N,N-1"  ); // n_cycles:#nodes:#nodes:...  

   // Tmlp(Root)ANN
   if (Use["TMlpANN"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kTMlpANN, "TMlpANN", "H:!V:NCycles=10000:HiddenLayers=N+1,1:LearningMethod=Batch:ValidationFraction=0.5:CreateMVAPdfs=True"  ); // n_cycles:#nodes:#nodes:...HiddenLayers:#of HiddenLayers=2,#of Neurons in the first HiddenLayer=N+1,#of Neurons in the second HiddenLayer=N,N=#of variables

   // Support Vector Machine
   if (Use["SVM"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kSVM, "SVM", "Gamma=0.25:Tol=0.001:VarTransform=Norm" );

   // Boosted Decision Trees
   if (Use["BDTG"]) // Gradient Boost
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kBDT, "BDTG",
   ...
   if (Use["BDT"])  // Adaptive Boost
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kBDT, "BDT",
   ...
   if (Use["BDTB"]) // Bagging
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kBDT, "BDTB",
                           "!H:!V:NTrees=1000:BoostType=Bagging:SeparationType=GiniIndex:nCuts=20:PruneMethod=NoPruning" );

   if (Use["BDTD"]) // Decorrelation + Adaptive Boost
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kBDT, "BDTD",
   ...
   if (Use["BDTF"])  // Allow Using Fisher discriminant in node splitting for (strong) linearly correlated variables
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kBDT, "BDTMitFisher",
   ...
   if (Use["RuleFit"])
      factory->BookMethod( ROOT_DATALOADER_MAYBE  TMVA::Types::kRuleFit, "RuleFit",
                           "H:!V:RuleFitModule=RFTMVA:Model=ModRuleLinear:MinImp=0.001:RuleMinDist=0.001:NTrees=20:fEventsMin=0.01:fEventsMax=0.5:GDTau=-1.0:GDTauPrec=0.01:GDStep=0.01:GDNSteps=10000:GDErrScale=1.02" );

#undef ROOT_DATALOADER_MAYBE
...
int  MVAmanager::initfactory() {
 ...
 string fmvalocation=theconf->Value("MVA","weightfile_location");
  ...
  TString outfileName(fout.c_str());
...
factory = new TMVA::Factory( TString(weightfile.c_str()), outputFile, "!V:!Silent:Color:DrawProgressBar:Transformations=I:AnalysisType=Classification" );
#if ROOT_VERSION_CODE > ROOT_VERSION(6,7,2)
dataloader = new TMVA::DataLoader( TString(weightfile.c_str()) );
#endif
...
#if ROOT_VERSION_CODE > ROOT_VERSION(6,7,2)
   dataloader->AddVariable(((*ip)->name).c_str(),((*ip)->title).c_str(),"", 'F',(*ip)->valmin,(*ip)->valmax);
#else
...
#if ROOT_VERSION_CODE > ROOT_VERSION(6,7,2)
   dataloader->AddSpectator(((*ip)->name).c_str(),((*ip)->title).c_str(),"",'F');
#else
  ...
  if(Debug)cout<<"MVAmanager::bookreader()"<<endl;
	...
	for (std::map<std::string,int>::iterator it = Use.begin(); it != Use.end(); it++) {
      if (it->second) {
         ...
         TString methodName = TString(it->first.c_str()) + " method";
         TString weightfile = TString(location.c_str()) + TString(prefix.c_str()) + "_" +  TString(it->first.c_str()) + ".weights.xml";
...
int MVAmanager::train(vector<TTree*> ts, vector<TTree*> tb, vector<double> ws, vector<double> wb) 
{
  if(Debug) cout<<" MVAmanager::train()"<<endl;
...
#if ROOT_VERSION_CODE > ROOT_VERSION(6,7,2)
		dataloader->AddSignalTree    ( ts.at(nsig),     signalWeight );
#else
...
#if ROOT_VERSION_CODE > ROOT_VERSION(6,7,2)
		dataloader->AddBackgroundTree( tb.at(nbg), backgroundWeight );
#else
   ...
   if(Debug) cout<<" train n "<<sns<<" "<<snb<<endl;
	 TString NTrain_Signal=string(sns).c_str();
	 TString NTrain_Background=string(snb).c_str();
#if ROOT_VERSION_CODE > ROOT_VERSION(6,7,2)
...
float  MVAmanager::getclassifier(string mname) {
  if(Debug) cout<<"getclassifier( mname)"<<endl;
  TString classifier = TString(mname.c_str()) + " method";
