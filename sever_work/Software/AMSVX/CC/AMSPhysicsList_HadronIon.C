...
void AMSPhysicsList_HadronIon::ConstructProcess() {
    ...
    */
...
#if G4VERSION_NUMBER  >  999 
    G4AntiDeuteronInelasticProcess* fAntiDeuteronProcess = new G4AntiDeuteronInelasticProcess("adInelastic");
    G4AntiHe3InelasticProcess* fAntiHe3Process = new G4AntiHe3InelasticProcess("aHe3Inelastic");
    G4AntiAlphaInelasticProcess* fAntiAlphaProcess = new G4AntiAlphaInelasticProcess("aalphaInelastic");
#endif
	...
	//======AntiDeuteron
        ...
        if ((G4FFKEY.IonPhysicsModel/10)%10==3) fAntiDeuteronProcess->AddDataSet(HEAOXS);
        if ((G4FFKEY.IonPhysicsModel/10)%10==2) fAntiDeuteronProcess->AddDataSet(generalCrossSection);
        fAntiHe3Process->AddDataSet(fShen);
        if ((G4FFKEY.IonPhysicsModel/10)%10==3) fAntiHe3Process->AddDataSet(HEAOXS);
        if ((G4FFKEY.IonPhysicsModel/10)%10==2) fAntiHe3Process->AddDataSet(generalCrossSection);
        fAntiAlphaProcess->AddDataSet(fShen);
        if ((G4FFKEY.IonPhysicsModel/10)%10==3) fAntiAlphaProcess->AddDataSet(HEAOXS);
        if ((G4FFKEY.IonPhysicsModel/10)%10==2) fAntiAlphaProcess->AddDataSet(generalCrossSection);
  ...
  G4CrossSectionInelastic* anucxs = 
    new G4CrossSectionInelastic(apgg);
        ...
        if ((G4FFKEY.IonPhysicsModel/10)%10==1) fAntiDeuteronProcess->AddDataSet(anucxs);
        if ((G4FFKEY.IonPhysicsModel/10)%10==1) fAntiHe3Process->AddDataSet(anucxs);
        if ((G4FFKEY.IonPhysicsModel/10)%10==1) fAntiAlphaProcess->AddDataSet(anucxs);
	fAntiDeuteronProcess->RegisterMe(theGenIonBC);
	fAntiHe3Process->RegisterMe(theGenIonBC);
	fAntiAlphaProcess->RegisterMe(theGenIonBC);
	particle = G4AntiDeuteron::AntiDeuteron();
	pManager = particle->GetProcessManager();
	pManager->AddDiscreteProcess(fAntiDeuteronProcess);
	particle = G4AntiHe3::AntiHe3();
	pManager = particle->GetProcessManager();
	pManager->AddDiscreteProcess(fAntiHe3Process);
	particle = G4AntiAlpha::AntiAlpha();
	pManager = particle->GetProcessManager();
	pManager->AddDiscreteProcess(fAntiAlphaProcess);
	...
	pManager = particle->GetProcessManager();
        ...
        if ((G4FFKEY.IonPhysicsModel/10)%10==3) fDeuteronProcess->AddDataSet(HEAOXS);
        if ((G4FFKEY.IonPhysicsModel/10)%10==2) fDeuteronProcess->AddDataSet(generalCrossSection);
#if G4VERSION_NUMBER  > 945 
        if ((G4FFKEY.IonPhysicsModel/10)%10==1) fDeuteronProcess->AddDataSet(fGG);
#endif
	...
	pManager = particle->GetProcessManager();
        ...
        if ((G4FFKEY.IonPhysicsModel/10)%10==3) fTritonProcess->AddDataSet(HEAOXS);
        if ((G4FFKEY.IonPhysicsModel/10)%10==2) fTritonProcess->AddDataSet(generalCrossSection);
#if G4VERSION_NUMBER  > 945 
        if ((G4FFKEY.IonPhysicsModel/10)%10==1) fTritonProcess->AddDataSet(fGG);	
#endif
	...
	pManager = particle->GetProcessManager();
        ...
        if ((G4FFKEY.IonPhysicsModel/10)%10==3) fAlphaProcess->AddDataSet(HEAOXS);
        if ((G4FFKEY.IonPhysicsModel/10)%10==2) fAlphaProcess->AddDataSet(generalCrossSection);
#if G4VERSION_NUMBER  > 945 
        if ((G4FFKEY.IonPhysicsModel/10)%10==1) fAlphaProcess->AddDataSet(fGG);
#endif
	...
	G4HadronInelasticProcess* fhe3Ion = new G4HadronInelasticProcess("He3Inelastic",particle);
        ...
        if ((G4FFKEY.IonPhysicsModel/10)%10==3) fhe3Ion->AddDataSet(HEAOXS);
        if ((G4FFKEY.IonPhysicsModel/10)%10==2) fhe3Ion->AddDataSet(generalCrossSection);
#if G4VERSION_NUMBER  > 945 
        if ((G4FFKEY.IonPhysicsModel/10)%10==1) fhe3Ion->AddDataSet(fGG);
#endif
	...
	G4HadronInelasticProcess* fGenericIon = new G4HadronInelasticProcess("IonInelastic",particle);
        ...
        if ((G4FFKEY.IonPhysicsModel/10)%10==3) fGenericIon->AddDataSet(HEAOXS);
        if ((G4FFKEY.IonPhysicsModel/10)%10==2) fGenericIon->AddDataSet(generalCrossSection);
#if G4VERSION_NUMBER  > 945 
        if ((G4FFKEY.IonPhysicsModel/10)%10==1) fGenericIon->AddDataSet(fGG);
#endif
