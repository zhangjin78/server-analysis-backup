...
// ********************************************************************
//
// $Id: G4HadronPhysicsQGSP_BIC_AMS.C,v 1.2 2015/04/06 10:38:59 wxu Exp $
//
//---------------------------------------------------------------------------
//
// ClassName:   G4HadronPhysicsQGSP_BIC_AMS
//
...
// 02.04.2015 W.Xu   : Remove FTFP for proton simulation, only use QGSP and BIC
//
//----------------------------------------------------------------------------
//
#include <iomanip>   

#include "G4HadronPhysicsQGSP_BIC_AMS.h"
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(G4HadronPhysicsQGSP_BIC_AMS);

G4ThreadLocal G4HadronPhysicsQGSP_BIC_AMS::ThreadPrivate* 
G4HadronPhysicsQGSP_BIC_AMS::tpdata = 0;

G4HadronPhysicsQGSP_BIC_AMS::G4HadronPhysicsQGSP_BIC_AMS(G4int)
...
{}
	...
	G4HadronPhysicsQGSP_BIC_AMS::G4HadronPhysicsQGSP_BIC_AMS(const G4String& name, G4bool /* quasiElastic */)
...
void G4HadronPhysicsQGSP_BIC_AMS::CreateModels()
{
	...
	const G4double minQGSP_Proton = 9.9*GeV;
	const G4double maxBIC_Proton = 10.0*GeV;
...
//	tpdata->theFTFPPro->SetMaxEnergy(maxFTFP);
	tpdata->theQGSPPro->SetMinEnergy(minQGSP_Proton);

	tpdata->thePro->RegisterMe(tpdata->theBinaryPro=new G4BinaryProtonBuilder);
	tpdata->theBinaryPro->SetMaxEnergy(maxBIC_Proton);
...
G4HadronPhysicsQGSP_BIC_AMS::~G4HadronPhysicsQGSP_BIC_AMS() 
{
	if (!tpdata) return;
...
void G4HadronPhysicsQGSP_BIC_AMS::ConstructParticle()
{
...
void G4HadronPhysicsQGSP_BIC_AMS::ConstructProcess()
{
