//  $Id: commonsi.C,v 1.471 2023/12/19 19:37:20 qyan Exp $
#include <unistd.h>
#include <sys/types.h>
#include <sys/time.h>
#include "system_bg.h"
...
uinteger AMSCommonsI::_build=1307;
...
void AMSCommonsI::init(){ 
  ...
  cerr.setstate(ios_base::failbit);
   ...
   strcpy(_osversion,"0.0");
     ...
     if(_os){
      if(pri)cout <<"AMSCommonsI-I-HardwareIdentifiedAs "<< u.sysname<<" "<<u.release<<" "<<u.machine<<" "<<_os<<endl;
     }
     else{
