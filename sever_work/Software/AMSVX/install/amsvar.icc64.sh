...
if [[ -f /etc/redhat-release ]]; then
    ...
    if [[ "$RH_Version" == "6" ]]; then
        export LD_LIBRARY_PATH=.:/cvmfs/ams.cern.ch/opt/intel/composer_xe_2011_sp1.9.293/compiler/lib/intel64/:$ROOTSYS/lib:/cvmfs/ams.cern.ch/opt/intel/compiler80/lib:$ROOTSYS/lib
        export PATH=$ROOTSYS/bin:/cvmfs/ams.cern.ch/opt/intel/composer_xe_2011_sp1.9.293/compiler/bin/intel64:$PATH:.:/usr/sbin
    fi
fi
