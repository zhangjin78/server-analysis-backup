//  $Id: geant321g.h,v 1.20 2016/06/01 10:02:35 choutko Exp $
...
#ifdef __PPC64
#define GCKINE COMMON_BLOCK(GCKINEMT,gckinemt)
#define GCKINEST COMMON_BLOCK(GCKINE,gckine)
COMMON_BLOCK_DEF(GCKINE_DEF,GCKINEST);
#else
...
#ifdef G4MULTITHREADED
#ifdef __PPC64
#define GCTRAK COMMON_BLOCK(GCTRAKMT,gctrakmt)
COMMON_BLOCK_DEF(GCTRAK_DEF,GCTRAK);
#pragma omp threadprivate(GCTRAK)
#define GCTRAKST COMMON_BLOCK(GCTRAK,gctrak)
COMMON_BLOCK_DEF(GCTRAK_DEF,GCTRAKST);
#else
