//  $Id: ecaldbc.h,v 1.56 2017/10/21 11:27:05 xueqiang Exp $
...
class ECALDBc {  
 ...
 public:  
  ...
  //wxq_begin
  static integer is_fiberinfo_init;
  static geant fibercoot[9][10][500];//coot of fiber center
  static geant fibercooz[9][10][500];//cooz of fiber center
  static integer CellID[9][10][500][2];
  static number FiberWeight[9][10][500][2];
  static void ct2cida(number ct, integer ss, number cz, integer cell_id[2], number fiber_weight[2]);//used in init_fiberinfo_table()
  static void init_fiberinfo_table();
  static void fid2cida_fibrot(integer fid, integer cid[4], number w[4]);//Add fiber rotation in fid2cida
  //wxq_end
