...
#pragma omp threadprivate(_header)
 ...
 public:
  ...
  // Flags
  static bool init_checkRichPmtTemperatures, initok_checkRichPmtTemperatures, stop_checkRichPmtTemperatures;
  static bool init_getRichPmtTemperatures  , initok_getRichPmtTemperatures  , stop_getRichPmtTemperatures  ;
  static bool init_getRichBrickTemperatures, initok_getRichBrickTemperatures, stop_getRichBrickTemperatures;
  static bool init_CheckRichRun            , initok_CheckRichRun            , stop_CheckRichRun            ;
  static bool init_ReadPmtDB               , initok_ReadPmtDB               , stop_ReadPmtDB               ;

  // Vectors & Maps
  static vector<int>    v_pmt_dts, v_utime;
  static vector<float>  v_temp[48];

  static vector<int>    v_pmt_rep;
  static vector<string> v_dts_el, v_dts_nn;
  static multimap<float,int> m_pmt_d2_dts[680];

  static vector<int>    v_pmt_rep_brick;
  static vector<string> v_dts_el_brick, v_dts_nn_brick;
  static multimap<float,int> m_pmt_d2_dts_brick[680];

  static map<int,string> m_tag[4];
  static vector<unsigned short> w_pmt_stat, w_pmt_volt;
  static vector<string> v_brick_name[4];
  static vector<int> v_brick_busa[4], v_brick_busb[4], v_brick_fgin[4];
