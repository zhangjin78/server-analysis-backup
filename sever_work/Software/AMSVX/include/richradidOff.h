#ifndef __RICHRADIDOFF__
#define __RICHRADIDOFF__
...
namespace RichOffline{
  ...
  private:
    ...
    static RichRadiatorTile ***_tiles_agl_2D;  // The AGL tiles themselves (as a 2D array)
    static RichRadiatorTile ***_tiles_naf_2D;  // The NaF tiles themselves (as a 2D array)
  ...
  public:
    ...
    static void Init(const char *filename="RichDefaultAGLTables.04.dat");     // Init geometry and kinds and so on
