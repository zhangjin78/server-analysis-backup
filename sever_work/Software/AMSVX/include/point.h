//  $Id: point.h,v 1.41 2016/04/17 09:11:22 bbeische Exp $
...
public:
  ...
  integer operator ==(const AMSPoint & o) const{return ((_x-o._x)*(_x-o._x)+(_y-o._y)*(_y-o._y)+(_z-o._z)*(_z-o._z))<1E-10;}
