/// $Id: TkCoo.h,v 1.6 2015/12/01 18:17:57 shaino Exp $ 
#ifndef  _TKCOO_
#define  _TKCOO_
...
public:
  ...
  /// Return sequence ID of sensor grid
  static int GetSensorGridID(AMSPoint p);
  /// Convert SensorGridID to TkID and sensor number
  static void ConvertGridID(int gid, int &tkid, int &sensor);
  /// Get center coordinates of SensorGridID
  static AMSPoint SensorGridIDPos(int gid);
};
