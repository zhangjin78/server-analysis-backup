...
int run_Sum1_AMS_5_castorT2(char *infile="/afs/cern.ch/work/q/qyan/log/log1/amsmion_B636accts3546_1209015056_30file",char *outfile="test_2.root",const char *runlogdir="/afs/cern.ch/work/q/qyan/runlist/"){
   AMSChain *ch=0;
