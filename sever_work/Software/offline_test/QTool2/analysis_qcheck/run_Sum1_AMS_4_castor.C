...
int run_Sum1_AMS_4_castor(const char *infile="/afs/cern.ch/work/q/qyan/log/log1/bcanalysis4_13_69_ev9_1330391865_2012022801_20file",const char *outfile="test_2.root",const char *runlogdir="/afs/cern.ch/work/q/qyan/runlist/"){
   AMSChain *ch=0;
