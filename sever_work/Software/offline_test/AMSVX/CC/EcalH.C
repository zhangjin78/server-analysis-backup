//  $Id: EcalH.C,v 1.19 2022/06/07 14:36:50 qyan Exp $
...
///\date  2014/09/30 QY  ECAL Charge added
///
...
#endif
    char title[80];
    sprintf(title,"EcalHR::Lfun%d",thread);

  TF1 *func = new TF1(title, "(sqrt((x-[1])^2)+x-[1])/2"
