/*
 * $Id: timelx.c,v 1.7 2023/12/22 11:31:08 qyan Exp $
 *
 * $Log: timelx.c,v $
 * Revision 1.7  2023/12/22 11:31:08  qyan
 * Fix code
 *
 * Revision 1.6  2015/09/11 10:08:16  choutko
 * *** empty log message ***
 *
 * Revision 1.5  2015/09/06 11:39:04  choutko
 * fix timex for ia64
 *
...
static void time_st(float timl)
{
    times(&tps);
    timlim = timl;
