//  $Id: amschain.h,v 1.50 2017/01/14 20:40:19 pzuccon Exp $
#ifndef _AMSCHAIN_H
#define _AMSCHAIN_H
 ...
 */
  ...
  ///Get Entry id from run,event list from a text file (entry id can then be used with GetEntryNo())
  long long GetEntryFromList(int delta=1,const char* fnam="lout.txt", bool runinfilename=false, unsigned long long maxent=100000000);   
