...
class TrSimSensor {
  ...
  */
  ...
  //! Get diffusion width with Belau model
  double GetDiffusionWidth(double y0, int charge); 
  ...
  TrSimCluster MakeImplantCluster(double senscoo, double sensangle, double dzstep = 300, double sensheight = 0, double hallproj = 0, int charge = 0);
  ...
  TrSimCluster MakeCluster(double senscoo, double sensangle, int nsens = 0, double dzstep = 300, double sensheight = 0, double hallproj = 0, int charge = 0); 
  ...
  //! Calculare weight for the implanted-strip model (Belau model, very slow)
  double        GetWeightBelau(double senscoo, double sensheight, double sensstep, double sensangle, double x1, double x2, double hallproj, int z); 
