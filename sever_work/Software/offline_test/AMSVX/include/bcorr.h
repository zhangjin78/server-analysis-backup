//  $Id: bcorr.h,v 1.12 2022/03/08 08:26:46 choutko Exp $
...
public:
  void loadValues(unsigned int time,bool cceb=false,string dtmc="data:pass7:");
  ...
  MagnetTemperature(const MagnetTemperature &o):nsens(0),ncceb(0),time(0){};
