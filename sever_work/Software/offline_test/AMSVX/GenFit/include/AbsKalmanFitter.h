...
class AbsKalmanFitter : public AbsFitter {
 ...
 public:
  ...
  AbsKalmanFitter(unsigned int maxIterations = 4, double deltaPval = 1e-3, double blowUpFactor = 1e3)
    : AbsFitter(), minIterations_(2), maxIterations_(maxIterations), deltaPval_(deltaPval), deltaFBWPval_(1), deltaRigv_(1),relChi2Change_(0.2),
  ...
  /**
   * @brief Set Convergence criterion2 ForwardBackward Match in fitting
   */
  void setForwardBackwardDeltaPval(double deltaFBWPval){deltaFBWPval_=deltaFBWPval;}
  /**
   * @brief Set Convergence criterion3 d(1/R)/(1/R)<deltaRigv in fitting
   */
  void setDeltaRigv(double deltaRigv){deltaRigv_=deltaRigv;}
  /**
 ...
 protected:
  ...
  /**
   * @brief Convergence criterion2 ForwardBackward Match in fitting
   */
  double deltaFBWPval_;
  /**
   * @brief Set Convergence criterion3  d(1/R)/(1/R)<deltRigv in fitting
   */
  double deltaRigv_;
  /**
