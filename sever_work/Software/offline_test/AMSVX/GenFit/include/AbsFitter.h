...
class AbsFitter {
 public:
  AbsFitter() : debugLvl_(0),fixrigfit_(0),fixmsrig_(0){}
  virtual ~AbsFitter() {}
  ...
  virtual void setRigFixFit(bool fixrig = 1) {fixrigfit_=fixrig;}

  virtual void setFixMSRig(double fixmsrig) {fixmsrig_=fixmsrig;}
