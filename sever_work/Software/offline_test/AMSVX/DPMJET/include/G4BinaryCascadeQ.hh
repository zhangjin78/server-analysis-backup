...
#ifndef G4BinaryCascadeQ_hh
#define G4BinaryCascadeQ_hh
...
class G4BinaryCascadeQ : public G4VIntraNuclearTransportModel
{
public:

  G4BinaryCascadeQ(G4VPreCompoundModel* ptr = 0);

  virtual ~G4BinaryCascadeQ();
...
private:
  ...
  G4BinaryCascadeQ(const G4BinaryCascadeQ & right);
  const G4BinaryCascadeQ& operator=(G4BinaryCascadeQ & right);
  G4int operator==(G4BinaryCascadeQ& right) {return (this == &right);}
  G4int operator!=(G4BinaryCascadeQ& right) {return (this != &right);}
...
inline void G4BinaryCascadeQ::SetEexcFactor(G4double useexc){
  fEexc=useexc;
}
#endif
