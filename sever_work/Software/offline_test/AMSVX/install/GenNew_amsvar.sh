...
mecho
#get SLC 5 or 6
mexport DD  "\`cat /etc/redhat-release|awk '{print \$4}'|cut -c1\`"
IfThen \$DD   "S"
...
ElseIfThen \$DD  6
mexport SLC slc6
echo  source /cvmfs/sft.cern.ch/lcg/contrib/gcc/4.9.3/x86_64-slc6/setup.$MYSHELL  /afs/cern.ch/sw/lcg/external >>$FILEOUT
mexport INTELSW /cvmfs/projects.cern.ch
echo  source \$INTELSW/intelsw/psxe/linux/all-setup.$MYSHELL >>$FILEOUT
echo  source \$INTELSW/intelsw/psxe/linux/x86_64/2019/compilers_and_libraries/linux/bin/compilervars.$MYSHELL   intel64 >>$FILEOUT
mexport PATH /afs/cern.ch/sw/lcg/external/gdb/7.8/x86_64-slc6-gcc48-opt/bin:\$PATH
mexport INTELDIR \$INTELSW/intelsw/psxe/linux/x86_64/2019
mexport INTELVER compilers_and_libraries_2019.3.199
ElseIfThen \$DD 7 
mexport SLC slc6 
echo source /cvmfs/sft.cern.ch/lcg/contrib/gcc/5.3.0/x86_64-centos7-gcc53-opt/setup.$MYSHELL /afs/cern.ch/sw/lcg/external >>$FILEOUT 
mexport INTELSW /cvmfs/projects.cern.ch
echo  source \$INTELSW/intelsw/psxe/linux/all-setup.$MYSHELL >>$FILEOUT
echo  source \$INTELSW/intelsw/psxe/linux/x86_64/2019/compilers_and_libraries/linux/bin/compilervars.$MYSHELL   intel64 >>$FILEOUT
mexport PATH /afs/cern.ch/sw/lcg/external/gdb/7.8/x86_64-slc6-gcc48-opt/bin:\$PATH
...
echo "echo Your system is not supported" >>$FILEOUT
...
mexport G4DPMJET3_DATA \$Offline/AMSsoft/shared/geant4/data/tabs/
