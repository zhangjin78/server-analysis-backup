...
const string sElement[30] = {"", "He4", "Li0", "Be0", "B0", "C12", "N0", "O16", "F19", "Ne20", "Na23", "Mg24", "Al27", "Si28", "P31", "S32", "Cl35", "Ar36", "K39", "Ca40", "Sc45", "Ti48", "V51", "Cr52", "Mn55", "Fe56", "", "Ni58", "", ""};

const string sElementShort[30] = {"H", "He", "Li", "Be", "B", "C", "N", "O", "F", "Ne", "Na", "Mg", "Al", "Si", "P", "S", "Cl", "Ar", "K", "Ca", "Sc", "Ti", "V", "Cr", "Mn", "Fe", "Co", "Ni", "Cu", "Zn"};
