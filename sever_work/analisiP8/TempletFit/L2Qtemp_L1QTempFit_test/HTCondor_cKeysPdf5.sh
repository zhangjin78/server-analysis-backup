...
wdir="/afs/cern.ch/work/j/jzhang2/AMS/analisiP8/TempletFit/L2Qtemp_L1QTempFit_test" #XXX update to your directory
...
mycc=runplotKeysPdf_test #script name
# mycc=runplotKeysPdf_T1 #script name
# mycc=runplotKeysPdf_T2 #script name
# mycc=runplotKeysPdf_T3 #script name
# mycc=runplotKeysPdf_T4 #script name
