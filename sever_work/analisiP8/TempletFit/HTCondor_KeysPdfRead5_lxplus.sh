...
wdir="/afs/cern.ch/work/j/jzhang2/AMS/analisiP8/TempletFit" #XXX update to your directory
...
#---
# odir=${wdir}/amsd${dstver}n_${AmsVer}_${Version}_NVar${NVar}
# odir=${wdir}/amsd${dstver}n_${AmsVer}_${Version}_NVar${NVar}_ShiftAfterFit_L2
# odir=${wdir}/SubJob/amsd${dstver}n_${AmsVer}_${Version}_NVar${NVar}_Si_L1Range0_AllL1
odir=${wdir}/SubJob/amsd${dstver}n_${AmsVer}_${Version}_NVar${NVar}_Si_AllL1
...
# mycc=KeysPdfRead_2Sur #script name
...
#---
# fRig=20
# lRig=21 #XXX change the range of rigidity bin accordingly
fRig=0
