...
int cKeysPdf5(const int run_charge=4, const int StoreRig=22, const int QVer=1)
{
	...
	// outdir = Form("/afs/cern.ch/work/j/jzhang2/AMS/plot/SurvivalProb/RootFile/KeysPDF/UBL1Qabove3/amsd69nChenYa_B1130_KeysPDF_SURSEL_asSurProbSe_Z7TZ18.root");
	outdir = Form("/afs/cern.ch/work/j/jzhang2/AMS/plot/SurvivalProb/RootFile/KeysPDF/UBL1Qabove3/amsd69nChenYa_B1130_KeysPDF_SURSEL_asSurProbSe_Z4TZ18.root");
	#endif
	cout << outdir << endl;
	...
	// string sOutDir = Form("%s/LQTemp_CutHe_Z7TZ18_rho2p0", outPic.c_str());
	string sOutDir = Form("%s/LQTemp_CutHe_Z4TZ18_rho2p0", outPic.c_str());
	
	int Charge=run_charge;
	int iNVar=(Charge<=10)?3:4;
	// iNVar = 5; ////total iNvar pdfs
	// iNVar = 12; ////total iNvar pdfs
	iNVar = 15; ////total iNvar pdfs
