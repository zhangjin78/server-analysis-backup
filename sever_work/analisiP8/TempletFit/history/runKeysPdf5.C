...
int KeysPdf5(const int run_charge=6, const int StoreRig=0, const int QVer=1)
{
	...
	#elif defined SDIAT
	sHomeDir = "/home/ams/jzhang/AMS/Flux/Sulfur/plot/SurvivalProbability"; //XXX
	#endif
	string outdir=Form("/home/ams/jzhang/AMS/Flux/Sulfur/plot/SurvivalProbability/root/CHARGECAL_NEWTRQ");
	cout << outdir << endl;
...
void runKeysPdf5(){
	int a= 0;
	const int ich = 6;
	for(int i = 19; i < 23; i ++) a = KeysPdf5(ich, i, 1);
}