...
void runplotKeysPdf_T2(const int run_charge=13, const int SelRig=20)
{
	...
	///----- output file
	string sDrawL1QTempFit = Form("%sresult/T2", wdir.c_str());
	...
	TH1F *hL1QTemp = (TH1F*)fQTemplate.Get(Form("Charge_Calibration1/q%d/L1Inner/L1QTemp/rig%d/l1/L1Q_r1_q%d_xy2_L1QTemp2.0sigma_sel1_rig%d_Tk2nd0", run_charge, SelRig, run_charge, SelRig));
	int NRebin = 5;
	...
	double L2QXY = 0;
	tLQTemp->SetBranchAddress("UBL1QXY", &L2QXY);
