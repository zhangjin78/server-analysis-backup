...
wdir="/afs/cern.ch/work/j/jzhang2/AMS/analisiP8/TemplateFit/RooNDKeysPDF/checkPDF/FitPDF25" #XXX update to your directory
...
#---
# odir=${wdir}/SubJob/Z${iCharge}_SinglePdfFit_Rebin
odir=${wdir}/SubJob/Z${iCharge}_SinglePdfFit_Rebin_ShiftL2

echo "odir=${odir}"
# echo "JobFlavour is ${queuename}"

#--
mycc=singleFit25 #script name
...
do
	...
	echo "${cdir}" "${mycc}" "${iCharge}" "${irig}"  > ${odir}/submit/arg/${jobname}
