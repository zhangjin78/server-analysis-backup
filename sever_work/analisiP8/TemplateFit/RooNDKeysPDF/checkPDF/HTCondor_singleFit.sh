...
wdir="/afs/cern.ch/work/j/jzhang2/AMS/analisiP8/TemplateFit/RooNDKeysPDF/checkPDF" #XXX update to your directory
...
#---
odir=${wdir}/SubJob/Z${fCharge}_Z${lCharge}_NDKeysPdf_Rebin
