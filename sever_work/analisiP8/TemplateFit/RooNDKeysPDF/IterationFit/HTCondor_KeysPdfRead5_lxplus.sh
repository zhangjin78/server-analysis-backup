...
wdir="/afs/cern.ch/work/j/jzhang2/AMS/analisiP8/TemplateFit/RooNDKeysPDF/IterationFit" #XXX update to your directory
...
odir=${wdir}/SubJob/amsd${dstver}n_${AmsVer}_NVar${NVar}_RunQ${charge}_RebinRho_L1QRebin_Migration_R16
...
#--
mycc=KeysPdfFit_Iteration #script name
cpcfile="${mycc}.C"
