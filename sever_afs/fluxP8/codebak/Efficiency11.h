			...
			if (bL1Sam)
			{
				...
				for (int igr=1; igr>=0; igr--)
				{
					...
					if (igr==1)
					{
						...
						histn += sRig; //2022.10.03
						histn += sName; //2022.10.16
						GetHist2d(hman1, histn.c_str())->Fill(ev.GetTkLQNew(0, 2, QVer), ev.GetUBExtQTrkCor(0, 2, QVer));

						histn = Form("unbiasedL1Q_BetaCorvsTrkCor_r%d_q%d_%s%d", ir, *it, sEff.c_str(), 0);
						histn += sRig; //2022.10.03
						histn += sName; //2022.10.16
						GetHist2d(hman1, histn.c_str())->Fill(ev.GetUBExtQTrkCor(0, 2, QVer), ev.GetUBExtQBetaCor(0, 2, QVer));

						histn = Form("TKposxVSunbiasedL1Q_r%d_q%d_%s%d", ir, *it, sEff.c_str(), 0);
						histn += sRig; //2022.10.03
						histn += sName; //2022.10.16
						GetHist2d(hman1, histn.c_str())->Fill(ev.GetUBExtQTrkCor(0, 2, QVer), ev.tk_pos[0][0]);

						histn = Form("TKposyVSunbiasedL1Q_r%d_q%d_%s%d", ir, *it, sEff.c_str(), 0);
						histn += sRig; //2022.10.03
						histn += sName; //2022.10.16
						GetHist2d(hman1, histn.c_str())->Fill(ev.GetUBExtQTrkCor(0, 2, QVer), ev.tk_pos[0][1]);

						histn = Form("TKpos1sxVSunbiasedL1Q_r%d_q%d_%s%d", ir, *it, sEff.c_str(), 0);
						histn += sRig; //2022.10.03
						histn += sName; //2022.10.16
						GetHist2d(hman1, histn.c_str())->Fill(ev.GetUBExtQTrkCor(0, 2, QVer), ev.tk_pos1s[0][0]);

						histn = Form("TKpos1syVSunbiasedL1Q_r%d_q%d_%s%d", ir, *it, sEff.c_str(), 0);
						histn += sRig; //2022.10.03
						histn += sName; //2022.10.16
						GetHist2d(hman1, histn.c_str())->Fill(ev.GetUBExtQTrkCor(0, 2, QVer), ev.tk_pos1s[0][1]);

						histn = Form("TKpos2sxVSunbiasedL1Q_r%d_q%d_%s%d", ir, *it, sEff.c_str(), 0);
						histn += sRig; //2022.10.03
						histn += sName; //2022.10.16
						GetHist2d(hman1, histn.c_str())->Fill(ev.GetUBExtQTrkCor(0, 2, QVer), ev.tk_pos2s[0][0]);

						histn = Form("TKpos2syVSunbiasedL1Q_r%d_q%d_%s%d", ir, *it, sEff.c_str(), 0);
						histn += sRig; //2022.10.03
						histn += sName; //2022.10.16
						GetHist2d(hman1, histn.c_str())->Fill(ev.GetUBExtQTrkCor(0, 2, QVer), ev.tk_pos2s[0][1]);

						histn = Form("unbiasedL1QvsRigHZBin_r%d_q%d_%s%d", ir, *it, sEff.c_str(), 0);
						histn += sRig; //2022.10.03
						histn += sName; //2022.10.16
						GetHist2d(hman1, histn.c_str())->Fill(dRigStore, ev.GetUBExtQTrkCor(0, 2, QVer));

						histn = Form("L1QvsRigHZBin_r%d_q%d_%s%d", ir, *it, sEff.c_str(), 0);
						histn += sRig; //2022.10.03
						histn += sName; //2022.10.16
						GetHist2d(hman1, histn.c_str())->Fill(dRigStore, ev.GetTkLQNew(0, 2, QVer));

						///Rig_Bin
						histn = Form("unbiasedL1QvsL1Q_Rig2p67T3p64_r%d_q%d_%s%d", ir, *it, sEff.c_str(), 0);
						histn += sRig; //2022.10.03
						histn += sName; //2022.10.16
						if(dRigStore > 2.67 && dRigStore < 3.64) GetHist2d(hman1, histn.c_str())->Fill(ev.GetTkLQNew(0, 2, QVer), ev.GetUBExtQTrkCor(0, 2, QVer));
						histn = Form("unbiasedL1QvsL1Q_Rig14p1T15p3_r%d_q%d_%s%d", ir, *it, sEff.c_str(), 0);
						histn += sRig; //2022.10.03
						histn += sName; //2022.10.16
						if(dRigStore > 14.1 && dRigStore < 15.3) GetHist2d(hman1, histn.c_str())->Fill(ev.GetTkLQNew(0, 2, QVer), ev.GetUBExtQTrkCor(0, 2, QVer));
						histn = Form("unbiasedL1QvsL1Q_Rig48p5T56p1_r%d_q%d_%s%d", ir, *it, sEff.c_str(), 0);
						histn += sRig; //2022.10.03
						histn += sName; //2022.10.16
						if(dRigStore > 48.5 && dRigStore < 56.1) GetHist2d(hman1, histn.c_str())->Fill(ev.GetTkLQNew(0, 2, QVer), ev.GetUBExtQTrkCor(0, 2, QVer));
						histn = Form("unbiasedL1QvsL1Q_Rig175T211_r%d_q%d_%s%d", ir, *it, sEff.c_str(), 0);
						histn += sRig; //2022.10.03
						histn += sName; //2022.10.16
						if(dRigStore > 175 && dRigStore < 211) GetHist2d(hman1, histn.c_str())->Fill(ev.GetTkLQNew(0, 2, QVer), ev.GetUBExtQTrkCor(0, 2, QVer));

						for(int ixy=0; ixy<3; ixy++){
							histn = Form("unbiasedL1QvsRigHZBin_r%d_q%d_xy%d_%s%d", ir, *it, ixy, sEff.c_str(), 0);
							histn += sRig; //2022.10.03
							histn += sName; //2022.10.16
							GetHist2d(hman1, histn.c_str())->Fill(dRigStore, ev.GetUBExtQTrkCor(0, ixy, QVer));
						}
						...
						if(!ev.isreal){
							...
							histn += sRig; //2022.10.03
							histn += sName; //2022.10.16
							GetHist2d(hman1, histn.c_str())->Fill(ev.GetTkLQNew(0, 2, QVer), ev.GetTrMCLZ(1));
							
							histn = Form("MCL1QvsunbiasedL1Q_r%d_q%d_%s%d", ir, *it, sEff.c_str(), 0);
							histn += sRig; //2022.10.03
							histn += sName; //2022.10.16
							GetHist2d(hman1, histn.c_str())->Fill(ev.GetUBExtQTrkCor(0, 2, QVer), ev.GetTrMCLZ(1));
							
							histn = Form("InnerQvsL1Q_r%d_q%d_%s%d", ir, *it, sEff.c_str(), 0);
							histn += sRig; //2022.10.03
							histn += sName; //2022.10.16
							GetHist2d(hman1, histn.c_str())->Fill(ev.GetTkLQNew(0, 2, QVer), ev.GetTkInQNew(2, QVer));
							
							histn = Form("InnerQvsunbiasedL1Q_r%d_q%d_%s%d", ir, *it, sEff.c_str(), 0);
							histn += sRig; //2022.10.03
							histn += sName; //2022.10.16
							GetHist2d(hman1, histn.c_str())->Fill(ev.GetUBExtQTrkCor(0, 2, QVer), ev.GetTkInQNew(2, QVer));

							for(int ixy=0; ixy<3; ixy++){
								histn = Form("L1Q_oldQvsNewQ_r%d_q%d_xy%d_%s%d", ir, *it, ixy, sEff.c_str(), 0);
								histn += sRig; //2022.10.03
								histn += sName; //2022.10.16
								GetHist2d(hman1, histn.c_str())->Fill(ev.GetTkLQNew(0, ixy, 4), ev.GetTkLQNew(0, ixy, 3));
							}
							...
							for(int alay = 1; alay < 8; alay++){
								...
								histn += sRig; //2022.10.03
								histn += sName; //2022.10.16
								GetHist2d(hman1, histn.c_str())->Fill(ev.GetTkLQNew(0, 2, QVer), ev.GetTkLQNew(alay, 2, QVer));

								// if(abs(ev.GetTkLQNew(0, 2, QVer) - *it) > 1.2) continue;
								histn = Form("L%dQvsunbiasedL1Q_r%d_q%d_%s%d", alay+1, ir, *it, sEff.c_str(), 0);
								histn += sRig; //2022.10.03
								histn += sName; //2022.10.16
								GetHist2d(hman1, histn.c_str())->Fill(ev.GetUBExtQTrkCor(0, 2, QVer), ev.GetTkLQNew(alay, 2, QVer));
							}
							for(int alay = 0; alay < 8; alay++){
								histn = Form("unbiasedL1QvsL1Q_L%dpri_r%d_q%d_%s%d", alay+1, ir, *it, sEff.c_str(), 0);
								histn += sRig; //2022.10.03
								histn += sName; //2022.10.16
								if(ev.mtrpri[alay]) GetHist2d(hman1, histn.c_str())->Fill(ev.GetTkLQNew(0, 2, QVer), ev.GetUBExtQTrkCor(0, 2, QVer));
							}
							...
							if(ev.GetTkLQNew(0, 2, QVer) > *it + 2){
								...
								histn += sRig; //2022.10.03
								histn += sName; //2022.10.16
								GetHist2d(hman1, histn.c_str())->Fill(ev.mtrcoo[0][0], ev.mtrcoo[0][1]);

								histn = Form("L1QLimit_cooZ_r%d_q%d_%s%d", ir, *it, sEff.c_str(), 0);
								histn += sRig; //2022.10.03
								histn += sName; //2022.10.16
								GetHist(hman1, histn.c_str())->Fill(ev.mtrcoo[0][2]);
								histn = Form("L1QLimit_mom_r%d_q%d_%s%d", ir, *it, sEff.c_str(), 0);
								histn += sRig; //2022.10.03
								histn += sName; //2022.10.16
								GetHist(hman1, histn.c_str())->Fill(ev.mtrmom[0]);
								histn = Form("L1QLimit_Rig_r%d_q%d_%s%d", ir, *it, sEff.c_str(), 0);
								histn += sRig; //2022.10.03
								histn += sName; //2022.10.16
								GetHist(hman1, histn.c_str())->Fill(dRigStore);
								histn = Form("L1QLimit_Rig_r%d_q%d_%s%dpri", ir, *it, sEff.c_str(), 0);
								histn += sRig; //2022.10.03
								histn += sName; //2022.10.16
								if(ev.mtrpri[0]) GetHist(hman1, histn.c_str())->Fill(dRigStore);
							}
				...
				for (int itightsam=0; itightsam<2; itightsam++)
				{
					...
					for (int igr=1; igr>=0; igr--)
					{
						...
						if (igr==1)
						{
							...
							histn += sRig; //2022.10.03
							histn += sName; //2022.10.16
							GetHist2d(hman1, histn.c_str())->Fill(dRigStore, ev.GetChis(1,1,irig));

							histn = Form("L1ChisqvsRigHZBin_r%d_q%d_%s%d", ir, *it, sEff.c_str(), 0);
							histn += sRig; //2022.10.03
							histn += sName; //2022.10.16
							GetHist2d(hman1, histn.c_str())->Fill(dRigStore, ev.GetL1ChisY());

							histn = Form("L1InnerL9NormChisqvsRigHZBin_r%d_q%d_%s%d", ir, *it, sEff.c_str(), 0);
							histn += sRig; //2022.10.03
							histn += sName; //2022.10.16
							GetHist2d(hman1, histn.c_str())->Fill(dRigStore, ev.GetChis(2,1,irig));
							#endif //SELCHECK
						}
						...
						bool bL1PUSel_wChisqL1Inner_4 = bL1PUSel_wChisqL1Inner_3 && ev.GetChis(1, 1, irig) < 10;
				...
				for (int itightsam=0; itightsam<2; itightsam++)
				{
					...
					for (int igr=1; igr>=0; igr--)
					{
						...
						if (il9 == 1){
							...
							if (igr==0) histn += "_gen";
							histn += sRig; //2023.03.22
							GetHist2d(hman1, histn.c_str())->Fill(dRigStore, ev.GetTkLQNew(8, 2, QVer));
							...
							if (igr==0) histn += "_gen";
							histn += sRig; //2023.03.22
							GetHist2d(hman1, histn.c_str())->Fill(dRigStore, ev.GetTOFUDQ(1));
